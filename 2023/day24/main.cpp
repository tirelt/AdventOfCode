...
int main(){
    ...
    // Solving a system of 4 unknown and 4 equations for x,y and same for x,z. the sytems come from equalling the non linear term with trajectory 0
    ...
    //Very annoying roiunding error that I don't want to fix, the result is 976976197397181 not 976976197397185
